...
# Search
go find (everywhere | all): user.idea("action SearchEverywhere")
go find (everywhere | all) <user.text> [over]:
    user.idea("action SearchEverywhere")
    sleep(500ms)
    insert(text)
go (search | find) class: user.idea("action GotoClass")
go (search | find) file: user.idea("action GotoFile")
go (search | find) path: user.idea("action FindInPath")
go (search | find): key(ctrl-f)
go (search | find) next: key(f3)
go (search | find) (previous | prev): key(shift-f3)
